CREATE TABLE IF NOT EXISTS `World_Life_Expectancy_Continents` (
    `name` VARCHAR(52) CHARACTER SET utf8,
    `alpha_2` VARCHAR(2) CHARACTER SET utf8,
    `alpha_3` VARCHAR(3) CHARACTER SET utf8,
    `country_code` INT,
    `iso_3166_2` VARCHAR(13) CHARACTER SET utf8,
    `region` VARCHAR(8) CHARACTER SET utf8,
    `sub_region` VARCHAR(31) CHARACTER SET utf8,
    `intermediate_region` VARCHAR(15) CHARACTER SET utf8,
    `region_code` INT,
    `sub_region_code` INT,
    `intermediate_region_code` INT
);
INSERT INTO `World_Life_Expectancy_Continents` VALUES ('Afghanistan','AF','AFG',4,'ISO 3166-2:AF','Asia','Southern Asia',NULL,142,34,NULL),
	('Åland Islands','AX','ALA',248,'ISO 3166-2:AX','Europe','Northern Europe',NULL,150,154,NULL),
	...
	('Christmas Island','CX','CXR',162,'ISO 3166-2:CX','Oceania','Australia and New Zealand',NULL,9,53,NULL),
	('Cocos (Keeling) Islands','CC','CCK',166,'ISO 3166-2:CC','Oceania','Australia and New Zealand',NULL,9,53,NULL),
	...
	('Democratic Republic of the Congo','CD','COD',180,'ISO 3166-2:CD','Africa','Sub-Saharan Africa','Middle Africa',2,202,17),
	...
	('Côte D''Ivoire','CI','CIV',384,'ISO 3166-2:CI','Africa','Sub-Saharan Africa','Western Africa',2,202,11),
	...
	('Curaçao','CW','CUW',531,'ISO 3166-2:CW','Americas','Latin America and the Caribbean','Caribbean',19,419,29),
	...
	('Swaziland','SZ','SWZ',748,'ISO 3166-2:SZ','Africa','Sub-Saharan Africa','Southern Africa',2,202,18),
	...
	('Heard Island and McDonald Islands','HM','HMD',334,'ISO 3166-2:HM','Oceania','Australia and New Zealand',NULL,9,53,NULL),
	...
	('Democratic People''s Republic of Korea','KP','PRK',408,'ISO 3166-2:KP','Asia','Eastern Asia',NULL,142,30,NULL),
	('Republic of Korea','KR','KOR',410,'ISO 3166-2:KR','Asia','Eastern Asia',NULL,142,30,NULL),
	...
	('Republic of Moldova','MD','MDA',498,'ISO 3166-2:MD','Europe','Eastern Europe',NULL,150,151,NULL),
	...
	('The former Yugoslav republic of Macedonia','MK','MKD',807,'ISO 3166-2:MK','Europe','Southern Europe',NULL,150,39,NULL),
	...
	('Réunion','RE','REU',638,'ISO 3166-2:RE','Africa','Sub-Saharan Africa','Eastern Africa',2,202,14),
	...
	('Saint Barthélemy','BL','BLM',652,'ISO 3166-2:BL','Americas','Latin America and the Caribbean','Caribbean',19,419,29),
	...
	('Taiwan','TW','TWN',158,'ISO 3166-2:TW','Asia','Eastern Asia',NULL,142,30,NULL),
	('Tajikistan','TJ','TJK',762,'ISO 3166-2:TJ','Asia','Central Asia',NULL,142,143,NULL),
	('United Republic of Tanzania','TZ','TZA',834,'ISO 3166-2:TZ','Africa','Sub-Saharan Africa','Eastern Africa',2,202,14),
	...
	('United States Minor Outlying Islands','UM','UMI',581,'ISO 3166-2:UM','Oceania','Micronesia',NULL,9,57,NULL),
